    ...
    <Container maxWidth="xl">
      ...
      <Container maxWidth="md">
        <Box sx={{
          ...
          <Stack spacing={2}>
            {acessos.length ? acessos.map((acesso, index) => (
              <Box key={index}>
              ...
              <Grid xs={10}>
                <Typography variant='button' fontSize={16} color="#fff">Não foram encontrados acessos registrados</Typography>
              </Grid>
            </Grid>}
          </Stack>
        </Box>
